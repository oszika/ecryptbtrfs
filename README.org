...
#+BEGIN_SRC sh
Create a readonly snapshot of '/volume/.voltest.ecryptfs' in '/volumes/.voltest.ecryptfs/.snaps/.init.ecryptfs'
#+END_SRC
...
#+BEGIN_SRC sh
Create a readonly snapshot of '/volume/.voltest.ecryptfs' in '/volumes/.voltest.ecryptfs/.snaps/.2017-06-10-16:05:06.ecryptfs'
#+END_SRC
